...
export default async function handler(req, res) {
  if (req.method === "POST") {
    try {
      ...
      回复时先重申一下梦境再做出总体的解梦，然后按分类再对梦境做出各自的简短的解读，

      分类可以在商人、办公族、学生、未成年、男人、女人、老年人、青年人、中年人、病人、出行者、求学者中选择合适的五个以上。
      
      单个分类完毕后进行分隔操作再继续下一分类。
    ...
    A:梦见别人送馒头，预示着运势很不错，自己不管遇到什么问题，很快就可以解决掉。
    ...
    A:梦见富士山，吉兆，预示着你最近可能会做了好事被大家称赞，心情舒畅。
    ...
    A:梦见买彩票中大奖，预示你最近的健康状况很好，今后的抵抗力也会进一步的增强，身体的健康也能让你在事业上干劲十足，离成功很近。
